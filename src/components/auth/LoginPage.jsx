...
export function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result.success) {
        showToast(`Login successful!  back, ${result.user?.name || "User"}!`, "success");
        navigate("/");
      } else {
  ...
  // Create a custom logo component since Logo import is removed
  const CustomLogo = () => (
    <div className="flex items-center space-x-2">
      ...
      <div className="text-left">
        ...
        <p className="text-xs text-gray-500">365 Dashboard</p>
      </div>
    </div>
  );
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-emerald-50 p-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">Sign in to access your dashboards and reports</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden">
          <div className="p-8">
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                className="w-full py-2 px-4 bg-white border border-gray-300 rounded-lg shadow-sm text-gray-700 font-medium hover:bg-gray-50 transition-colors flex items-center justify-center"
              >
              ...
              <button
                type="button"
                className="w-full py-2 px-4 bg-gray-800 border border-gray-800 rounded-lg shadow-sm text-white font-medium hover:bg-gray-900 transition-colors flex items-center justify-center"
              >
        ...
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-400 text-xs">
            © {new Date().getFullYear()} BI Portal 365. All rights reserved.
          </p>
        </div>
      </div>
    </div>
