...
// import { useAuth } from '../AuthContext';
// // import { useUser } from '../AuthContext'; // ✅ import your new context
...
//   const fileInputRef = useRef(null);
//   const { user } = useAuth();
//   const { userLogo, handleUploadLogo, fetchUserLogo } = useAuth(); // ✅ use logo helpers
...
//   // ✅ Auto-update preview when context logo changes
//   useEffect(() => {
...
//   /**
//    * ✅ Handles logo file selection + preview + upload
//    */
...
//     } catch (error) {
//       showToast("error in uploading logo","error")
//     }
//     // ✅ Upload to backend (updates logo in DB + refreshes context)
